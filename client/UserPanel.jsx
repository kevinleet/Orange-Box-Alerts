    ...
    <Container className="bg-light mt-md-3 py-3 rounded w-100 ">
      <Container style={{ maxWidth: "950px" }} className="text-center">
        ...
        <h6 className="lead mt-4">
          ...
          subscriptions, providing our consumers with a secure and hassle-free
          experience, thanks to Stripe's robust security measures and
          user-friendly interface.
        </h6>
        <br />
        <p>
          Once your payment is successfully processed, your subscription will be
          activated within 24 hours. Once activated, you will start receiving
          restock alert notifications whenever they occur, ensuring you never
          miss out!
        </p>
      </Container>
