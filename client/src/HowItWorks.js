    ...
    <div className="container mt-2 bg-light mt-4 px-5 py-3 rounded w-75">
      <div className="jumbotron">
        ...
        <p className="mt-4 text-center my-4">
          Hermés Alerter integrates the latest enterprise-grade technologies to
          bypass and defeat bot-detection countermeasures.
        </p>
        <p className="lead"></p>
        <div className="accordion w-75 mx-auto my-3" id="accordionExample">
          ...
          <div className="accordion-item">
            ...
            >
              <div className="accordion-body">
                ...
                searching the Hermes web store for new product restocks. <br />
                <div className="mt-3">
